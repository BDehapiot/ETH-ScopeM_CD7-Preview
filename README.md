...
![Date Badge](https://img.shields.io/badge/Created-2023--05--17-blue?labelColor=rgb(50%2C60%2C65)&color=rgb(149%2C157%2C165))
...
```
Your prompt should now start with `(CZITools)` instead of `(base)`
